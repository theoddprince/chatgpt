...
dialog dlgMain
{
	...
	surface	     = "srfDlgBackTL";
	surface	     = "srfDlgBackCL";
	surface	     = "srfDlgBackBL";
	surface	     = "srfDlgBackTC";
	surface	     = "srfDlgBackCC";
	surface	     = "srfDlgBackBC";
	surface	     = "srfDlgBackTR";
	surface	     = "srfDlgBackCR";
	surface	     = "srfDlgBackBR";
	...
	button btnPartySearch
	{
		...
		surface_file 	= "MainBtn.srf";
		surface_up   	= "srfPartyMatchingUp";
		surface_down   	= "srfBtnDown";
		surface_down   	= "srfPartyMatchingDown";
		surface_focus  	= "srfBtnFoc";
		surface_focus  	= "srfPartyMatchingFoc";
	}
	...
	button btnMascot
	{
		...
		surface_file 	= "MainBtn.srf";
		surface_up   	= "srfIconMascotUp";
		surface_down   	= "srfBtnDown";
		surface_down   	= "srfIconMascotDown";
		surface_focus  	= "srfBtnFoc";
		surface_focus  	= "srfIconMascotFoc";
	}
